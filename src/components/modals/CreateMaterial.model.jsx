            ...
            <div className=" flex flex-col gap-1 items-start justify-start">
                ...
                <div className="w-fit overflow-hidden">
                  <input
                    ...
                    {...register("materilaName", {required: true})}
                  />
                </div>
              </div>
              ...
              <div className=" flex flex-col gap-1 items-start justify-start">
                ...
                <div className="w-fit overflow-hidden">
                  ...
                  />
                   {errors.Brand && <p className="text-sm text-red-500 italic">Brand is required.</p>}
                </div>
              </div>
              ...
              <div className=" flex flex-col gap-1 items-start justify-start">
                ...
                <div className="w-fit overflow-hidden">
                  ...
                  />
                  {errors.unit && <p className="text-sm text-red-500 italic">Unit is required.</p>}
                </div>
              </div>
