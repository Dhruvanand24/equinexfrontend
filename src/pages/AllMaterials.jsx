...
const AllMaterials = () => {
  ...
  return (
    <div className='bg-white p-4 w-full flex flex-col justify-start items-start h-full'>
      <p className='font-semibold text-[#4A5568] text-xl p-2 pl-0'>All Materials</p>
       ...
       <div className='filtersection flex flex-wrap gap-[50px] p-4'>
            ...
            <div className=' flex flex-col gap-1'>
                ...
                <div className='relative w-fit overflow-hidden'>
                    <input className=' w-[256px] bg-[#edf1fa] text-[#8792A4] rounded-sm border-[#D9D9D9] border-[1px] px-4 py-2 cursor-text outline-blue-500' type="text" placeholder='Search by Name / ID'/>
     ...
     <div className='flex w-full px-4'>
      ...
      <button className=" px-4 py-2 bg-blue-500 rounded-[5px] text-white left-[85%] hover:bg-blue-600" onClick={()=>document.getElementById('create_new_material_modal').showModal()}>+ Add Material</button>
       {/* <Modala /> */}
       <CreateMaterial />
     </div>
