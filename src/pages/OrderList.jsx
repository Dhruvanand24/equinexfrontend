       ...
       <div className='filtersection flex gap-[50px] p-4'>
            ...
            <div className=' flex flex-col gap-1'>
                ...
                <div className='relative w-fit overflow-hidden'>
                    <input className=' w-[256px] bg-[#BACFFF] text-[#8792A4] bg-opacity-25 rounded-sm border-[#BACFFF] border-[1px] px-4 py-2 cursor-text outline-blue-500' type="text" placeholder='Purchase Order No.'/>
            ...
            <div className=' flex flex-col gap-1'>
                ...
                <div className='relative w-fit overflow-hidden'>
                    <input className=' w-[256px] bg-[#BACFFF] text-[#8792A4] bg-opacity-30 rounded-sm border-[#D9D9D9] border-[1px] px-4 py-2 cursor-text outline-blue-500' type="text" placeholder='Purchase Order No.'/>
